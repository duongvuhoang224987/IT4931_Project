...
BOOTSTRAP_SERVERS = "k-broker-0.k-broker-svc:9092,k-broker-1.k-broker-svc:9092"
...
spark = SparkSession.builder \
    ...
    .config("spark.mongodb.write.connection.uri", "mongodb://root:root@mongo-service:27017/") \
...
location_df = spark.read \
    ...
    .option("partitionColumn", "location_id") \
    .option("lowerBound", "1") \
    .option("upperBound", "265") \
...
def upsert_to_mongo(batch_df, batch_id):
    batch_df.write \
        .format("mongodb") \
        .option("spark.mongodb.write.connection.uri", "mongodb://root:root@mongo-service:27017/") \

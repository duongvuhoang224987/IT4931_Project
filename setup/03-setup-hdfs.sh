...
kubectl cp -n $NAMESPACE $DATA_DIR/it4931_project/data/taxi_zone_lookup.csv $NAMENODE_POD:/tmp/data/taxi_zone_lookup.csv

# Copy thư mục yellow_taxi vào pod
echo "Copy yellow_taxi directory vào pod..."
kubectl cp -n $NAMESPACE $DATA_DIR/it4931_project/data/yellow_taxi/ $NAMENODE_POD:/tmp/data/yellow_taxi/
